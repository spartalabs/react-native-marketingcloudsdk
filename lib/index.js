...
class MCReactModule {
    ...
    /**
     * Enable geofence messaging on iOS and Android devices.
     * @see  {@link https://salesforce-marketingcloud.github.io/MarketingCloudSDK-Android/location/geolocation.html|Android Docs}
     * @see  {@link https://salesforce-marketingcloud.github.io/MarketingCloudSDK-iOS/location/geolocation-overview.html|iOS Docs}
     */
    static enableGeofence() {
        return RNMarketingCloudSdk.enableGeofence();
    }
     ...
     * @see  {@link https://salesforce-marketingcloud.github.io/MarketingCloudSDK-iOS/location/geolocation-overview.html|iOS Docs}
     */
    static disableGeofence() {
        return RNMarketingCloudSdk.disableGeofence();
    }

    /**
     * Sets the token used by the Marketing Cloud to send push messages to
     * the device.
     * @see  {@link https://salesforce-marketingcloud.github.io/MarketingCloudSDK-Android/javadocs/6.0/reference/com/salesforce/marketingcloud/messages/push/PushMessageManager.html#setPushToken()|Android Docs}
